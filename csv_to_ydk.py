...
def read_names(deck):
    names = []
    path = f"./deck_conversion/csv/{deck}.csv"
...
def convert_all():
    path = os.path.join(os.getcwd(),"deck_conversion","csv")
    ...
    for file in os.listdir(path):
        ...
        os.rename(f"./deck_conversion/csv/{deck}.csv", f"./deck_conversion/done/{deck}.csv")
